...
The program also has an integrated value search function, which will report the stress (<img src="https://latex.codecogs.com/svg.image?\sigma&space;" title="\sigma " />, MPa) at a specified strain (<img src="https://latex.codecogs.com/svg.image?\epsilon&space;" title="\epsilon " />).
