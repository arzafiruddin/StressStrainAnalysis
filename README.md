...
The program also has an integrated value search function, which will report the (<img src="https://latex.codecogs.com/svg.image?\sigma&space;" title="\sigma " /> (MPa) at a specified <img src="https://latex.codecogs.com/svg.image?\epsilon&space;" title="\epsilon " /> (the orange point labelled "CUSTOM" on *FIGURE #*).
